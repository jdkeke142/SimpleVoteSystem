...
import fr.keke142.ivernyavotes.commands.VoteCommand;
import fr.keke142.ivernyavotes.managers.ConfigManager;
...
import fr.keke142.ivernyavotes.tasks.VoteCheckerTask;
import fr.keke142.ivernyavotes.tasks.VoteCleanerTask;
import fr.keke142.ivernyavotes.websites.Liste_Serveurs_MinecraftOrgHasVoted;
import fr.keke142.ivernyavotes.websites.Serveur_PriveNetHasVoted;
import fr.keke142.ivernyavotes.websites.ServeursMinecraftOrgHasVoted;
import fr.keke142.ivernyavotes.websites.Serveurs_MinecraftOrgHasVoted;
...
public class IvernyaVotesPlugin extends Plugin implements Listener {
    private static IvernyaVotesPlugin instance;
    ...
    public static IvernyaVotesPlugin getInstance() {
        return instance;
    }
